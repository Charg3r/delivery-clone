  ...
  return (
    <SafeAreaView>
      <View>
        <View>
          <View>
            <Text className='text-lg font-bold text-center pt-4'>Basket</Text>
            <Text className='text-center text-gray-400 py-2'>{restaurant.title}</Text>
          </View>
        ...
        <View className='p-5 bg-whitw mt-5 space-y-4'>
          ...
          <View className='flex-row justify-between'>
            ...
            <Text className='text-gray-400'>$ 69</Text>
          </View>
